                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                ...
                                <NavLink exact className="nav-link"to={"/products"}>Product</NavLink>
                            </li>
                            <li className="nav-item">
                                {/* <a className="nav-link" href="blog_list.html">Blog</a> */}
                                <NavLink exact className="nav-link"to={"/Blogs"} >Blog</NavLink>
                            </li>
                            <li className="nav-item">
                                {/* <a className="nav-link" href="contact.html">Contact</a> */}
                                <NavLink  exact className="nav-link"to={"/contect"}>Contect</NavLink>
                            </li>
                            <li className="nav-item">
